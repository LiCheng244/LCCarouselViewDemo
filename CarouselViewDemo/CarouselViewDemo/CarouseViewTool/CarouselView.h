 ...
 *
 *  @param imageArray      图片数组
 *  @param imageClickBlock 点击图片时的block
 *
 */
- (instancetype)initWithImageArray:(NSArray *)imageArray
                   imageClickBlock:(void(^)(NSInteger index))imageClickBlock;

/**
 *  带 描述信息 的 轮播图
 *
 *  @param imageArray    图片数组
 *  @param describeArray 描述信息数组
 *
 */
...
/**
 *  设置分页控件指示器的图片 (两个图片必须同时设置，否则设置无效; 不设置则为系统默认)
 *
